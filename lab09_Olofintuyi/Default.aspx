<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="lab09_Olofintuyi.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h2>Data Source Example
                <asp:SqlDataSource ID="SqlDataSource1" 
                runat="server" 
                ConnectionString="<%$ ConnectionStrings:playerConnectionString %>" 
                ProviderName="<%$ ConnectionStrings:playerConnectionString.ProviderName %>" 
